...
//{
//    LOG_INFO(" Run(LPTSTR /*lpstrCmdLine = NULL*/, int nCmdShow/* = SW_SHOWDEFAULT*/) ...");
...
//    LOG_INFO("WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR lpstrCmdLine, int nCmdShow) ...");
//#ifdef _DEBUG
