...
BOOL CMessageLogger::CreateMsgLogFile()
{
    ...
    nRet = sqlite3_exec(conn, lpSql.c_str(), 0, 0, &err_msg);	// 创建好友消息表
    if (nRet != SQLITE_OK)
    {
        sqlite3_close(conn);
    ...
    nRet = sqlite3_exec(conn, lpSql.c_str(), 0, 0, &err_msg);	// 创建群消息表
    if (nRet != SQLITE_OK)
    {
        sqlite3_close(conn);
        ::DeleteFile(m_strFileName.c_str());
    ...
    nRet = sqlite3_exec(conn, lpSql.c_str(), 0, 0, &err_msg);	// 创建临时会话(群成员)消息表
    if (nRet != SQLITE_OK)
    {
        sqlite3_close(conn);
        ::DeleteFile(m_strFileName.c_str());
...
BOOL CMessageLogger::WriteBuddyMsgLog(BUDDY_MSG_LOG* lpMsgLog)
{
    ...
    std::string lpSql = "INSERT INTO [tb_BuddyMsg] ([id],[uin],[nickname],[time],[sendflag],[content]) VALUES (NULL,?,?,?,?,?)";
    int nRet;
    ...
    nRet = sqlite3_prepare(conn, lpSql.c_str(), -1, &stmt, &err_msg);
    if (nRet != SQLITE_OK)
    {
        sqlite3_close(conn);
        return FALSE;
...
BOOL CMessageLogger::WriteGroupMsgLog(GROUP_MSG_LOG* lpMsgLog)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "INSERT INTO [tb_GroupMsg] ([id],[groupnum],[uin],[nickname],[time],[content]) VALUES (NULL,?,?,?,?,?)";
    int nRet;
...
BOOL CMessageLogger::WriteSessMsgLog(SESS_MSG_LOG* lpMsgLog)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "INSERT INTO [tb_SessMsg] ([id],[uin],[nickname],[time],[sendflag],[content]) VALUES (NULL,?,?,?,?,?)";
    int nRet;
...
UINT CMessageLogger::GetBuddyMsgLogCount(UINT nUTalkNum)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "SELECT COUNT(*) FROM [tb_BuddyMsg] WHERE [uin]=?";
    int nRet;
...
UINT CMessageLogger::GetGroupMsgLogCount(UINT nGroupNum)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "SELECT COUNT(*) FROM [tb_GroupMsg] WHERE [groupnum]=?";
    int nRet;
...
UINT CMessageLogger::GetSessMsgLogCount(UINT nUTalkNum)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "SELECT COUNT(*) FROM [tb_SessMsg] WHERE [uin]=?";
    int nRet;
...
BOOL CMessageLogger::DelAllBuddyMsgLog()
{
    sqlite3*conn = NULL;
    char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_BuddyMsg]";
    int nRet;
    ...
    nRet = sqlite3_exec(conn, lpSql.c_str(), 0, 0, &err_msg);
...
BOOL CMessageLogger::DelAllGroupMsgLog()
{
    sqlite3*conn = NULL;
    char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_GroupMsg]";
    int nRet;
...
BOOL CMessageLogger::DelAllSessMsgLog()
{
    sqlite3*conn = NULL;
    char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_SessMsg]";
    int nRet;
...
BOOL CMessageLogger::DelBuddyMsgLog(UINT nUTalkNum)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_BuddyMsg] WHERE [uin]=?";
    int nRet;
...
BOOL CMessageLogger::DelGroupMsgLog(UINT nGroupNum)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_GroupMsg] WHERE [groupnum]=?";
    int nRet;
...
BOOL CMessageLogger::DelSessMsgLog(UINT nUTalkNum)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_SessMsg] WHERE [uin]=?";
    int nRet;
...
UINT CMessageLogger::DelBuddyMsgLogByText(LPCTSTR lpStr)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    //std::string lpSql = "DELETE FROM [tb_BuddyMsg] WHERE [content]=?";
    std::string lpSql = "SELECT [id]= FROM [tb_BuddyMsg] WHERE [content]=?";
    UINT nRet;
...
BOOL CMessageLogger::DelBuddyMsgLogByID(UINT nID)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_BuddyMsg] WHERE [id]=?";
    int nRet;
...
BOOL CMessageLogger::DelGroupMsgLogByID(UINT nID)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_GroupMsg] WHERE [id]=?";
    int nRet;
...
BOOL CMessageLogger::DelSessMsgLogByID(UINT nID)
{
    ...
    sqlite3_stmt*stmt = NULL;
    const char*err_msg = NULL;
    std::string lpSql = "DELETE FROM [tb_SessMsg] WHERE [id]=?";
    int nRet;
